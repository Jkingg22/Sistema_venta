...
class TestBusquedaProductoNombre():
  ...
  def test_busquedaProductoNombre(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#table_filter .form-control").send_keys("Televisor")
