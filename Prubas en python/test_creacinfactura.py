...
class TestCreacinfactura():
  ...
  def test_creacinfactura(self):
    ...
    self.driver.find_element(By.ID, "txt_cod_producto").send_keys("1")
    self.driver.find_element(By.ID, "txt_cod_producto").click()
    self.driver.find_element(By.ID, "txt_cod_producto").send_keys("2")
    self.driver.find_element(By.ID, "txt_cod_producto").click()
    self.driver.find_element(By.ID, "txt_cod_producto").send_keys("3")
    self.driver.find_element(By.ID, "txt_cod_producto").click()
    self.driver.find_element(By.ID, "txt_cod_producto").send_keys("4")
    self.driver.find_element(By.ID, "txt_cod_producto").click()
    self.driver.find_element(By.ID, "txt_cod_producto").send_keys("5")
    self.driver.find_element(By.ID, "txt_cod_producto").click()
